...
class Messages extends Component {
    ...
    handleSearchChange = event => {
        this.setState({
            searchTerm: (event.target.value === '\\' ? '\\\\' : event.target.value),
            searchLoading: true,
        }, () => {
    ...
    handleSearchMessages = () => {
        ...
        const regex = new RegExp((this.state.searchTerm === '?' ? '\\?' : this.state.searchTerm), 'gi');
